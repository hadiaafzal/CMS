...
public class Aprofile extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Aprofile.class.getName());
    private String ID;
    /**
...
try {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Aprofile().setVisible(true));
    }
