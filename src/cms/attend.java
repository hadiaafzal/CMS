...
public class attend extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(attend.class.getName());
    ...
    private void initComponents() {
        ...
        if (attendance.getColumnModel().getColumnCount() > 0) {
            attendance.getColumnModel().getColumn(0).setHeaderValue("Checkbox");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new attend().setVisible(true));
    }
